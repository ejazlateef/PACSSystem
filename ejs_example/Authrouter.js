...
Authrouter.get('/pages-registration', function (req, res) {
    res.locals = {  title: 'pages-registration' };
    res.render('Auth/registration');
    });

    Authrouter.get('/pages-otp-radiologist-verification', function (req, res) {
    res.locals = {  title: 'pages_otp_radiologist_verification' };
    res.render('Auth/otp_radiologist_verification');
    });

    Authrouter.get('/pages-email-radiologist-verification', function (req, res) {
    res.locals = {  title: 'pages_email_radiologist_verification' };
    res.render('Auth/email_radiologist_verification');
    });
