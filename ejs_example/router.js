...
router.get('/sample-blank', function (req, res) {
    res.locals = { title: 'pages-blank' };
    res.render('Sample/sample');
});
router.get('/pages-radiologist-view', function (req, res) {
    res.locals = { title: 'pages-radiologist_view' };
    res.render('Radiologist/radiologist_view');
});
router.get('/pages-radiologist-list', function (req, res) {
    res.locals = { title: 'pages-radiologist_list' };
    res.render('Radiologist/radiologist_list');
});
router.get('/pages-radiologist-add-experience', function (req, res) {
    res.locals = { title: 'pages-radiologist-add-experience' };
    res.render('Radiologist/radiologist_add_experience');
});


router.get('/pages-radiologist-add-documents', function (req, res) {
    res.locals = { title: 'pages-radiologist-add-documents' };
    res.render('Radiologist/radiologist_add_documents');
});


router.get('/pages-radiologist-view-documents', function (req, res) {
    res.locals = { title: 'pages-radiologist_View_experience' };
    res.render('Radiologist/radiologist_view_documents');
});

router.get('/pages-document-requirements-list', function (req, res) {
    res.locals = { title: 'pages-document-requirements-list' };
    res.render('Admin/admin_document_list');
});

router.get('/pages-add-checklist-documents', function (req, res) {
    res.locals = { title: 'pages-add-checklist-documents' };
    res.render('Admin/admin_add_checklist');
});

router.get('/pages-add-required-documents', function (req, res) {
    res.locals = { title: 'pages-add-required-documents' };
    res.render('Admin/admin_add_documents');
});


router.get('/pages-reviewer-process-list', function (req, res) {
...
router.get('/pages-tenant-user-add-form', function (req, res) {
    res.locals = { title: 'pages-tenant-user-add-form' };
